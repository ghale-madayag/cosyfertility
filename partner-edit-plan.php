...
<head>
  ...
  <title>Update Assessment | Co-Sy Fertility Clinic</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="partner-plan.php"> Plan</a></li>
    ...
    <section class="content container-fluid">
      ...
      <?php require_once('inc/partner-plan-edit.php');?>
...
<script src="js/plan-partner.js"></script>
