...
<head>
  ...
  <title>Update New Patient | Co-Sy Fertility Clinic</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="actual-follow-up"><i class="fa fa-dashboard"></i> Actual Follow-up Visit</a></li>
        <li class="active">Update Actual Follow-up Visit</li>
    ...
    <section class="content container-fluid">
      ...
      <?php require_once('inc/actual-edit.php');?>
