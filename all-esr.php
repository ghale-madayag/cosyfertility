...
<head>
  ...
  <title>All Embryology Summary Report | Co-Sy Fertility Clinic</title>
      ...
      <div class="row">
        <div class="col-xs-12">
           <div class="box box-default">
              <div class="box-body">
                <?php require_once('inc/esr-all.php');?>
              </div>
            </div>
        </div>
      </div>
  ...
  $(function () {
    ...
    $(".checkbox-toggle").click(function () {
      ...
      if (clicks) {
        ...
        $(".esr-all input[type='checkbox']").iCheck("uncheck");
        $(".fa", this).removeClass("fa-check-square-o").addClass('fa-square-o');
      } else {
        //Check all checkboxes
        $(".esr-all input[type='checkbox']").iCheck("check");
