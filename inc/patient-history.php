  ...
  <div class="col-md-12">
    <div class="box box-solid">
      ...
      <div class="box-body" id="history-container">
        <form id="form-history-edit" enctype="multipart/form-data" method="post">
              ...
              <div class="box-body">
               ...
               <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="b1" name="b1" placeholder="Years" >
                    </div>
                  </div>
               </div>
               <div class="row">
                 <div class="form-group">
                    ...
                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="b2" name="b2" placeholder="Days" >
                    </div>
                  </div>
               </div>
               <div class="row">
                 <div class="form-group">
                    ...
                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="b3" name="b3" placeholder="e.g.,12 to 60">
                    </div>
                  </div>
               </div>
               <div class="row">
                 <div class="form-group">
                    ...
                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="b4" name="b4" placeholder="Days">
                    </div>
                  </div>
               </div>
               <div class="row">
               ...
               <div class="row">
                 <div class="form-group">
                    ...
                    <div class="col-xs-3">
                      <input type="date"  disabled class="form-control" id="b7" name="b7" placeholder="Days">
                    </div>
                  </div>
               </div>
               <div class="row">
              ...
              <div class="box-body">
               ...
               <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="c1" name="c1" placeholder="Year">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-xs-4">
                      <input type="text"  disabled  disabledclass="form-control" id="c2" name="c2" placeholder="">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="c3" name="c3" placeholder="">
                    </div>
                  </div>
               </div> 
               <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="c4" name="c4" placeholder="">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="c5" name="c5" placeholder="">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="c6" name="c6" placeholder="">
                    </div>
                  </div>
               </div>
               <div class="row">
               ...
               <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="c8" name="c8" placeholder="">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-xs-4">
                      <input type="text"  disabled  disabledclass="form-control" id="c9" name="c9" placeholder="">
                    </div>
                  </div>
               </div>
              </div>
              ...
              <div class="box-body">
               ...
               <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-xs-4">
                      <input type="text"  disabled  disabledclass="form-control" id="d1" name="d1" placeholder="">
                    </div>
                  </div>
               </div>
              </div>
              ...
              <div class="box-body">
               ...
               <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-xs-4">
                     <input type="text"  disabled  disabledclass="form-control" id="f9" name="f9" placeholder="other (specify)">
                    </div>
                  </div>
               </div>
             <!--   <div class="row">
                  <div class="form-group">
                    <div class="col-xs-4">
                     <input type="text"  disabled  disabledclass="form-control" id="d10" name="d10" placeholder="Year">
                    </div>
                  </div>
               </div> -->
               <div class="row">
                  <div class="form-group">
                    <div class="col-xs-4">
                     <input type="text"  disabled  disabledclass="form-control" id="f10" name="f10" placeholder="ovarian surgery ">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    <div class="col-xs-4">
                     <input type="text"  disabled  disabledclass="form-control" id="f11" name="f11" placeholder="L cyst(s) removed">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    <div class="col-xs-4">
                     <input type="text"  disabled  disabledclass="form-control" id="f12" name="f12" placeholder="R cyst(s)">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    <div class="col-xs-4">
                     <input type="text"  disabled  disabledclass="form-control" id="f13" name="f13" placeholder="L ovary removed  ">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    <div class="col-xs-4">
                     <input type="text"  disabled  disabledclass="form-control" id="f14" name="f14" placeholder="vaginal or bladder">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    <div class="col-xs-4">
                     <input type="text"  disabled  disabledclass="form-control" id="f15" name="f15" placeholder="(vaginal) for">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    <div class="col-xs-4">
                     <input type="text"  disabled  disabledclass="form-control" id="f16" name="f16" placeholder="(abdominal) ">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    <div class="col-xs-4">
                     <input type="text"  disabled  disabledclass="form-control" id="f17" name="f17" placeholder="ovarian">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    <div class="col-xs-4">
                     <input type="text"  disabled  disabledclass="form-control" id="f18" name="f18" placeholder="removed ovarian">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    <div class="col-xs-4">
                     <input type="text"  disabled  disabledclass="form-control" id="f19" name="f19" placeholder="tubal ligation">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    <div class="col-xs-4">
                     <input type="text"  disabled  disabledclass="form-control" id="f20" name="f20" placeholder="R ovary removed ">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    <div class="col-xs-4">
                     <input type="text"  disabled  disabledclass="form-control" id="f21" name="f21" placeholder="repair">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    <div class="col-xs-4">
                     <input type="text"  disabled  disabledclass="form-control" id="f22" name="f22" placeholder="prolapsed or incontinence ">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    <div class="col-xs-4">
                     <input type="text"  disabled  disabledclass="form-control" id="f23" name="f23" placeholder="cesarean section">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    <div class="col-xs-4">
                     <input type="text"  disabled  disabledclass="form-control" id="f24" name="f24" placeholder="myomectomy">
                    </div>
                  </div>
               </div>
              </div>
              ...
              <div class="box-body">
               ...
               <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-xs-3">
                      <input type="text"  disabled  disabledclass="form-control" id="g2" name="g2" placeholder="">
                    </div>
                    <label for="g3" class="col-md-3 control-label">Year: </label>

                    <div class="col-xs-3">
                      <input type="text"  disabled  disabledclass="form-control" id="g3" name="g3" placeholder="">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-xs-3">
                      <input type="text"  disabled  disabledclass="form-control" id="g4" name="g4" placeholder="">
                    </div>
                    <label for="g5" class="col-md-3 control-label">Year: </label>

                    <div class="col-xs-3">
                      <input type="text"  disabled  disabledclass="form-control" id="g5" name="g5" placeholder="">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-xs-3">
                      <input type="text"  disabled  disabledclass="form-control" id="g6" name="g6" placeholder="">
                    </div>
                    <label for="g7" class="col-md-3 control-label">Year: </label>

                    <div class="col-xs-3">
                      <input type="text"  disabled  disabledclass="form-control" id="g7" name="g7" placeholder="">
                    </div>
                  </div>
               </div>
              </div>
              ...
              <div class="box-body">
               ...
               <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-xs-3">
                      <input type="text"  disabled  disabledclass="form-control" id="h1" name="h1" placeholder="">
                    </div>
                  </div>
               </div>
               <div class="row">
               ...
               <div class="row">
                <div class="form-group">
                  ...
                  <div class="col-xs-3">
                     <input type="text"  disabled  disabledclass="form-control" id="h4" name="h4" placeholder="Year">
                  </div>
                </div>
               </div>
               <div class="row">
                <div class="form-group">
                  ...
                  <div class="col-xs-3">
                     <input type="text"  disabled  disabledclass="form-control" id="h5" name="h5" placeholder="Year">
                  </div>
                </div>
               </div>
               <div class="row">
                <div class="form-group">
                  ...
                  <div class="col-xs-3">
                     <input type="text"  disabled  disabledclass="form-control" id="h6" name="h6" placeholder="Year">
                  </div>
                </div>
               </div>
               <div class="row">
                <div class="form-group">
                  ...
                  <div class="col-xs-3">
                     <input type="text"  disabled  disabledclass="form-control" id="h7" name="h7" placeholder="Year">
                  </div>
                </div>
               </div>
               <div class="row">
                <div class="form-group">
                  ...
                  <div class="col-xs-3">
                     <input type="text"  disabled  disabledclass="form-control" id="h8" name="h8" placeholder="Month">
                  </div>
                  <div class="col-xs-3">
                     <input type="text"  disabled  disabledclass="form-control" id="h9" name="h9" placeholder="Year">
                  </div>
                </div>
               </div>
               <div class="row">
            ...
            <div id="collapse8" class="panel-collapse collapse">
              <div class="box-body">
               ...
               <div class="row">
                  <div class="form-group">
                    <div class="col-xs-4">
                      <input type="text"  disabled  disabledclass="form-control" name="i10" id="i10" placeholder="Other">
                    </div>
                  </div>
               </div>
              </div>
              ...
              <div class="box-body">
               ...
               <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="k1" name="k1" placeholder="">
                    </div>
                    <label for="k2" class="col-md-2 control-label">Dose: </label>

                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="k2" name="k2" placeholder="">
                    </div>
                    <label for="k3" class="col-md-2 control-label">Frequency : </label>

                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="k3" name="k3" placeholder="">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="k1-2" name="k1-2" placeholder="">
                    </div>
                    <label for="k2-2" class="col-md-2 control-label">Dose: </label>

                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="k2-2" name="k2-2" placeholder="">
                    </div>
                    <label for="k3-2" class="col-md-2 control-label">Frequency : </label>

                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="k3-2" name="k3-2" placeholder="">
                    </div>
                  </div>
               </div>
               <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="k1-3" name="k1-3" placeholder="">
                    </div>
                    <label for="k2-3" class="col-md-2 control-label">Dose: </label>

                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="k2-3" name="k2-3" placeholder="">
                    </div>
                    <label for="k3-3" class="col-md-2 control-label">Frequency : </label>

                    <div class="col-xs-2">
                      <input type="text"  disabled  disabledclass="form-control" id="k3-3" name="k3-3" placeholder="">
                    </div>
                  </div>
               </div>
              </div>
              ...
              <div class="box-body">
               ...
               <div class="row">
                 <div class="form-group">
                    ...
                    <div class="col-xs-1">
                      <input type="text"  disabled  disabledname="l2" id="l2" class="form-control">
                    </div>
                  </div>
               </div>
               <div class="row">
                 <div class="form-group">
                    ...
                    <div class="col-xs-1">
                      <input type="text"  disabled  disabledname="l4" id="l4" class="form-control">
                    </div>
                    <label for="l5" class="col-md-2 control-label">beer (bottles/day):</label>
                    <div class="col-xs-1">
                      <input type="text"  disabled  disabledname="l5" id="l5" class="form-control">
                    </div>
                    <label for="l6" class="col-md-2 control-label">hard liquid (oz./day):</label>
                    <div class="col-xs-1">
                      <input type="text"  disabled  disabledname="l6" id="l6" class="form-control">
                    </div>
                  </div>
               </div>
               <div class="row">
                 <div class="form-group">
                    ...
                    <div class="col-xs-1">
                      <input type="text"  disabled  disabledname="l8" id="l8" class="form-control">
                    </div>
                    <label for="l9" class="col-md-2 control-label">amount:</label>
                    <div class="col-xs-1">
                      <input type="text"  disabled  disabledname="l9" id="l9" class="form-control">
                    </div>
                  </div>
               </div>
               <div class="row">
                 <div class="form-group">
                    ...
                    <div class="col-xs-3">
                      <input type="text"  disabled  disabledname="l10" id="l10" class="form-control">
                    </div>
                    <label for="l11" class="col-md-2 control-label">How often:</label>
                    <div class="col-xs-3">
                      <input type="text"  disabled  disabledname="l11" id="l11" class="form-control">
                    </div>
                  </div>
               </div>
              </div>
            ...
            <div id="collapse12" class="panel-collapse collapse">
              <div class="box-body">
               ...
               <div class="row">
                 <div class="form-group">
                    <div class="col-xs-3">
                      <input type="text"  disabled  disabledname="m2" id="m2" class="form-control">
                    </div>
                  </div>
               </div>
               <div class="row">
                 <div class="form-group">
                    <div class="col-xs-3">
                      <input type="text"  disabled  disabledname="m3" id="m3" class="form-control">
                    </div>
                  </div>
               </div>
               <div class="row">
                 <div class="form-group">
                    <div class="col-xs-3">
                      <input type="text"  disabled  disabledname="m4" id="m4" class="form-control">
                    </div>
                  </div>
               </div>
              </div>
            ...
            <div id="collapse13" class="panel-collapse collapse">
              <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-4">
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-xs-4">
                        <input type="text"  disabled  disabledname="n5" id="n5" class="form-control">
                      </div>
                    </div>
                  </div>
               </div>
               ...
               <div class="row">
                 <div class="form-group">
                    <div class="col-xs-3">
                      <input type="text"  disabled  disabledname="n7" id="n7" class="form-control">
                    </div>
                  </div>
               </div>
               <div class="row">
                 <div class="form-group">
                    <div class="col-xs-3">
                      <input type="text"  disabled  disabledname="n8" id="n8" class="form-control">
                    </div>
                  </div>
               </div>
               <div class="row">
                 <div class="form-group">
                    <div class="col-xs-3">
                      <input type="text"  disabled  disabledname="n9" id="n9" class="form-control">
                    </div>
                  </div>
               </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-4">
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-xs-4">
                        <input type="text"  disabled  disabledname="o11" id="o11" class="form-control">
                      </div>
                    </div>
                  </div>
               </div>
